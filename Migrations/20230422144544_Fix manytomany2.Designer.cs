...
namespace PersonalFinanceMVC.Migrations
{
    ...
    [Migration("20230422144544_Fix manytomany2")]
    partial class Fixmanytomany2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserTodoCategory", b =>
                {
                    b.Property<string>("ApplicationUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("TodoCategoriesId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUsersId", "TodoCategoriesId");

                    b.HasIndex("TodoCategoriesId");

                    b.ToTable("TodoCategoryApplicationUser", (string)null);
                });
            ...
            modelBuilder.Entity("ApplicationUserTodoCategory", b =>
                {
                    ...
                    b.HasOne("PersonalFinanceMVC.Models.Entities.TodoCategory", null)
                        .WithMany()
                        .HasForeignKey("TodoCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
