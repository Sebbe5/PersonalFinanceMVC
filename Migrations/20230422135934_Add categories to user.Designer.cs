...
namespace PersonalFinanceMVC.Migrations
{
    ...
    [Migration("20230422135934_Add categories to user")]
    partial class Addcategoriestouser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserTodoCategory", b =>
                {
                    b.Property<int>("PreferredTodoCategoriesId")
                        .HasColumnType("int");

                    b.Property<string>("UsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("PreferredTodoCategoriesId", "UsersId");

                    b.HasIndex("UsersId");

                    b.ToTable("ApplicationUserTodoCategory");
                });
            ...
            modelBuilder.Entity("ApplicationUserTodoCategory", b =>
                {
                    b.HasOne("PersonalFinanceMVC.Models.Entities.TodoCategory", null)
                        .WithMany()
                        .HasForeignKey("PreferredTodoCategoriesId")
